...
``` r
anlz_wq_load(totanndat, smooth = "logistic", pct = 0.1)
```
...
- smooth:
  ...
  use a smooth logistic transition centered at each threshold instead of
  a hard 0/1 cutoff.
...
approaches 0, with a smooth logistic transition between them.
