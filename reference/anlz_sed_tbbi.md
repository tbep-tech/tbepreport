...
Uses
[`anlz_tbbiscr`](https://rdrr.io/pkg/tbeptools/man/anlz_tbbiscr.html) to
get station-level TBBI scores (0-100), filtered to the same stations
[`anlz_tbbimed`](https://rdrr.io/pkg/tbeptools/man/anlz_tbbimed.html)
...
the same clamped-breakpoint-window treatment used for the Nekton Index's
`from = c(32, 46)`.
